...
const ProdutoCard = ({ produto, onDetalhes, onAdicionar }) => {
  ...
  return (
    <div className="p-3 border-1 surface-border border-round surface-card shadow-1 relative">
      ...
      <div className="flex justify-content-between mt-3">
        <button className="p-button p-button-sm p-button-outlined" onClick={onDetalhes}>Detalhes</button>
        <button className="p-button p-button-sm p-button-success" onClick={onAdicionar}>Adicionar</button>
      </div>
    </div>
  );
};
