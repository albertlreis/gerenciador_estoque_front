export const PERMISSOES = {
  ...
  USUARIOS: {
    ...
    ATRIBUIR_PERFIL: 'usuarios.atribuir_perfil',
  ...
  PERFIS: {
    ...
    EXCLUIR: 'perfis.excluir',
    ATRIBUIR_PERMISSAO: 'perfis.atribuir_permissao',
  ...
  DEPOSITOS: {
    ...
    EDITAR: 'depositos.editar',
    EXCLUIR: 'depositos.excluir',
  },
  ESTOQUE: {
